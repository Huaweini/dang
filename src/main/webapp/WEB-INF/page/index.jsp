...
<head>
    ...
    <script type="text/javascript">
        ...
        function editPage(id) {
            var ajax = {
                url: "${pageContext.request.contextPath}/article/editParentTitleList",
                data: {
                    "id": id
                },
                type: "post",
        ...
        function edit() {
            var ajax = {
                url: "${pageContext.request.contextPath}/article/editParentTitle",
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin-top: -96px">
            <div class="row">
                <h2 class="sub-header" style="margin-left: 10px">模块管理</h2>
            </div>
            <div class="row">
